...
type SessionInterceptor interface {
	...
	List(ctx context.Context, filter *models.SessionFilter, requestUser *models.User) ([]*models.Session, uint64, error)
	Create(ctx context.Context, create *models.SessionCreate, requestUser *models.User) (*models.Session, error)
	Update(ctx context.Context, update *models.SessionUpdate, requestUser *models.User) (*models.Session, error)
