...
func (c *Approach) Validate() *errs.Error {
...
func (c *ApproachFilter) Validate() *errs.Error {
	err := validation.ValidateStruct(
		c,
...
func (c *ApproachCreate) Validate() *errs.Error {
	err := validation.ValidateStruct(
		c,
	)
	if err != nil {
...
func (c *ApproachUpdate) Validate() *errs.Error {
	err := validation.ValidateStruct(
		c,
