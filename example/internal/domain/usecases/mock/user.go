...
func (m *MockUserUseCase) Delete(arg0 context.Context, arg1 models.UUID) error {
	m.ctrl.T.Helper()
...
func (m *MockUserUseCase) Get(arg0 context.Context, arg1 models.UUID) (*models.User, error) {
	m.ctrl.T.Helper()
