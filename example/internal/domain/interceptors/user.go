...
type UserInterceptor interface {
	...
	List(ctx context.Context, filter *models.UserFilter, requestUser *models.User) ([]*models.User, uint64, error)
	Create(ctx context.Context, create *models.UserCreate, requestUser *models.User) (*models.User, error)
	Update(ctx context.Context, update *models.UserUpdate, requestUser *models.User) (*models.User, error)
