...
//nolint: lll
//go:generate mockgen -destination mock/session_mock.go github.com/018bf/example/internal/interceptors SessionInterceptor
...
func (i *SessionInterceptor) Get(ctx context.Context, id string, user *models.User) (*models.Session, error) {
...
func (i *SessionInterceptor) Update(
	...
	session, err := i.sessionUseCase.Update(ctx, update)
	if err != nil {
		return nil, err
	}
	return session, nil
...
func (i *SessionInterceptor) Delete(ctx context.Context, id string, user *models.User) error {
