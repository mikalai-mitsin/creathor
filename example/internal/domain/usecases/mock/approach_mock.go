...
func (m *MockApproachUseCase) Create(arg0 context.Context, arg1 *models.ApproachCreate) (*models.Approach, *errs.Error) {
	m.ctrl.T.Helper()
...
func (m *MockApproachUseCase) Delete(arg0 context.Context, arg1 string) *errs.Error {
	m.ctrl.T.Helper()
...
func (m *MockApproachUseCase) Get(arg0 context.Context, arg1 string) (*models.Approach, *errs.Error) {
	m.ctrl.T.Helper()
...
func (m *MockApproachUseCase) List(arg0 context.Context, arg1 *models.ApproachFilter) ([]*models.Approach, uint64, *errs.Error) {
	m.ctrl.T.Helper()
...
func (m *MockApproachUseCase) Update(arg0 context.Context, arg1 *models.ApproachUpdate) (*models.Approach, *errs.Error) {
	m.ctrl.T.Helper()
