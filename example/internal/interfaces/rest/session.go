...
func (h *SessionHandler) Create(ctx *gin.Context) {
	...
	marks, err := h.sessionInterceptor.Create(ctx.Request.Context(), create)
	if err != nil {
...
func (h *SessionHandler) List(ctx *gin.Context) {
	...
	marks, count, err := h.sessionInterceptor.List(ctx.Request.Context(), filter)
	if err != nil {
		ctx.JSON(http.StatusBadRequest, err)
		return
	}
...
func (h *SessionHandler) Get(c *gin.Context) {
	marks, err := h.sessionInterceptor.Get(c.Request.Context(), c.Param("id"))
	if err != nil {
...
func (h *SessionHandler) Update(c *gin.Context) {
	...
	marks, err := h.sessionInterceptor.Update(c.Request.Context(), update)
	if err != nil {
		c.JSON(http.StatusBadRequest, err)
		return
	}
...
func (h *SessionHandler) Delete(c *gin.Context) {
	err := h.sessionInterceptor.Delete(c.Request.Context(), c.Param("id"))
	if err != nil {
		c.JSON(http.StatusBadRequest, err)
		return
	}
