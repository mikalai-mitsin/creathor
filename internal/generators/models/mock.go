...
func NewMock(typeSpec *ast.TypeSpec, fileName string) *Mock {
	return &Mock{typeSpec: typeSpec, fileName: fileName}
}
...
func (m *Mock) Sync() error {
	...
	filename := path.Join("internal", "domain", "models", "mock", m.fileName)
