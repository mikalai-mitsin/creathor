...
type UserSessionRepository interface {
	...
	List(ctx context.Context, filter *models.UserSessionFilter) ([]*models.UserSession, error)
	Count(ctx context.Context, filter *models.UserSessionFilter) (uint64, error)
