...
func CreateLayout(project *Project) error {
	...
	if project.Auth {
		files = append(
			...
			&Template{
				SourcePath:      "templates/internal/repositories/auth.go.tmpl",
